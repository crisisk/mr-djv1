...
const StarRating = ({ rating }) => {
    const stars = Array(5).fill(0).map((_, i) => (
        <svg key={i} className={`w-5 h-5 ${i < rating ? 'text-secondary' : 'text-neutral-gray-500'}`} fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
...
const TestimonialCard = ({ testimonial }) => {
    return (
        <div className="bg-neutral-light p-spacing-xl rounded-lg shadow-xl flex flex-col h-full">
            ...
            <p className="text-font-size-h3 text-neutral-dark italic my-spacing-lg flex-grow">
                "{testimonial.quote}"
            </p>
