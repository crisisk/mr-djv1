        ...
        <div className="flex items-center justify-between">
          ...
          <nav className="hidden lg:flex items-center gap-8">
            ...
            <a
              ...
              className="text-base bg-gradient-to-r from-[#006BB8] to-[#004F89] text-white px-6 py-2.5 rounded-full hover:from-[#005F9F] hover:to-[#003B70] hover:shadow-lg transition-all font-bold"
            >
              Contact
            </a>
            <a
              ...
              className="text-base bg-[#8A6700] text-white px-6 py-2.5 rounded-full hover:bg-[#7A5500] transition font-bold flex items-center gap-2"
            >
          ...
          <nav className="lg:hidden mt-4 py-4 border-t border-gray-200 animate-fade-in">
            <div className="flex flex-col gap-3">
              ...
              <a
                href="/contact"
                onClick={handleContactClick}
                className="text-base bg-gradient-to-r from-[#006BB8] to-[#004F89] text-white px-6 py-3 rounded-lg hover:from-[#005F9F] hover:to-[#003B70] transition font-bold text-center mt-2"
              >
                Contact Opnemen
              </a>
              <a
                href="tel:+31408422594"
                onClick={handlePhoneClick}
                className="text-base bg-[#8A6700] text-white px-6 py-3 rounded-lg hover:bg-[#7A5500] transition font-bold text-center flex items-center justify-center gap-2"
              >
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                </svg>
