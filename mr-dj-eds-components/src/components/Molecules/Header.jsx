  ...
  return (
    <>
      <a
        ...
        className="fixed left-4 top-4 -translate-x-full transform focus:translate-x-0 focus:bg-white focus:text-[#1A2C4B] focus:px-4 focus:py-2 focus:rounded-md focus:shadow-lg focus:outline focus:outline-2 focus:outline-[#1A2C4B] text-sm font-semibold z-50"
      >
          ...
          <div className="flex items-center justify-between">
            ...
            <nav className="hidden lg:flex items-center gap-8">
              ...
              <a
                ...
                className="text-base bg-gradient-to-r from-[#00AEEF] to-[#0096D6] text-white px-6 py-2.5 rounded-full hover:shadow-lg transition-all font-bold"
              >
                Contact
              </a>
              <a
                ...
                className="text-base bg-[#D4AF37] text-white px-6 py-2.5 rounded-full hover:bg-[#C4A137] transition font-bold flex items-center gap-2"
              >
