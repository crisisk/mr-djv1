...
const localData = getLocalSeoDataBySlug(DEFAULT_CITY_SLUG) ?? {
  ...
  pricingHighlights: {
    ...
    zilver:
      "Dé beste DJ voor uw feest in Eindhoven en omgeving. Perfect voor bruiloften en bedrijfsfeesten in Eindhoven.",
  ...
  return (
    <div className="LocalSeoPage">
        ...
        <div className="container mx-auto px-spacing-md text-center">
          ...
          <div className="flex justify-center space-x-spacing-lg">
            {localVenues.map((venue, index) => (
              <span
                key={index}
                className="bg-neutral-gray-100 text-neutral-dark px-spacing-md py-spacing-sm rounded-full text-font-size-body shadow-sm"
              >
                {venue}
              </span>
            ))}
      ...
      <div className="bg-neutral-dark text-neutral-light py-spacing-2xl text-center">
        <h3 className="text-font-size-h2 font-bold mb-spacing-md">{footerHeading}</h3>
