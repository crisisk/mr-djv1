...
export default function SaxofonistOssPage() {
  return (
    <>
      <HeroSection
        eyebrow="Live Saxofonist"
        title="Saxofonist Oss | DJ met Saxofonist"
        subtitle="Boek een live saxofonist in Oss! Unieke combinatie van DJ + saxofonist voor jouw bruiloft of feest"
        ...
        badges={['Live Sax Oss', 'DJ + Sax Combo', '50+ Shows']}
        socialProof="🎷 De beste saxofonist van Oss"
      />

      <section className="py-spacing-3xl px-spacing-xl bg-white">
        <div className="container mx-auto max-w-4xl">
          <h2 className="font-display text-3xl font-bold text-gray-900 mb-6">
            Waarom Een Saxofonist in Oss?
          </h2>
          <div className="prose prose-lg text-gray-600">
            <p>
              Op zoek naar een <strong>saxofonist in Oss</strong>? Een live saxofonist maakt
              je bruiloft of feest in Oss extra bijzonder! De combinatie van een <strong>DJ met
              saxofonist Oss</strong> zorgt voor een unieke sfeer die je gasten niet snel vergeten.
            </p>
            <p>
              Onze <strong>saxofonist Oss</strong> speelt live mee met de beste house, deep house
              en party classics. Perfect voor bruiloften, bedrijfsfeesten en jubilea in Oss en omgeving!
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-spacing-3xl px-spacing-xl bg-gray-50">
        <div className="container mx-auto">
          <h2 className="font-display text-3xl font-bold text-gray-900 mb-12 text-center">
            Wat Maakt Onze Saxofonist Oss Uniek?
          </h2>
          ...
          <div className="grid md:grid-cols-4 gap-6">
            <Card className="text-center p-spacing-lg">
              ...
              <p className="text-gray-600 text-sm">
                Professionele saxofonist Oss speelt live tijdens de grootste hits
              </p>
            </Card>
            ...
            <Card className="text-center p-spacing-lg">
              ...
              <p className="text-gray-600 text-sm">
                Perfecte samenspel tussen DJ en saxofonist Oss
              </p>
            </Card>
            ...
            <Card className="text-center p-spacing-lg">
              ...
              <p className="text-gray-600 text-sm">
                Maak je event in Oss onvergetelijk met live saxofoon
              </p>
            </Card>
            ...
            <Card className="text-center p-spacing-lg">
              ...
              <p className="text-gray-600 text-sm">
                Saxofonist Oss met professionele lichtshow en sfeer
              </p>
            </Card>
          </div>
        </div>
      ...
      <section className="py-spacing-3xl px-spacing-xl bg-white">
        <div className="container mx-auto">
          <StatHighlights
            title="Ervaring als Saxofonist Oss"
            stats={[
              {
                label: 'Shows in Oss',
                value: '50+',
                description: 'DJ + Sax shows als saxofonist Oss verzorgd'
              },
              {
                label: 'Tevreden Klanten',
                value: '100%',
                description: 'Alle klanten bevelen onze saxofonist Oss aan'
              },
              {
                label: 'Gemiddelde Review',
                value: '5.0★',
                description: 'Perfect beoordeeld als saxofonist Oss'
              }
            ]}
      ...
      <section id="samples" className="py-spacing-3xl px-spacing-xl bg-gray-50">
        <div className="container mx-auto max-w-4xl">
          <h2 className="font-display text-3xl font-bold text-gray-900 mb-8 text-center">
            Saxofonist Oss in Actie
          </h2>

          <div className="grid md:grid-cols-2 gap-6">
            <Card className="p-spacing-lg">
              <div className="aspect-video bg-gray-200 rounded-lg mb-4 flex items-center justify-center">
                <span className="text-gray-400 text-sm">🎥 Video showreel saxofonist Oss</span>
              </div>
              <h3 className="font-semibold text-lg mb-2">Bruiloft Oss 2024</h3>
              <p className="text-gray-600 text-sm">
                Fragment van onze saxofonist tijdens een bruiloft in Oss
              </p>
            </Card>

            <Card className="p-spacing-lg">
              <div className="aspect-video bg-gray-200 rounded-lg mb-4 flex items-center justify-center">
                <span className="text-gray-400 text-sm">🎥 Video DJ + Sax Oss</span>
              </div>
              <h3 className="font-semibold text-lg mb-2">Bedrijfsfeest Oss</h3>
              <p className="text-gray-600 text-sm">
                DJ + Saxofonist Oss tijdens corporate event
              </p>
            </Card>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <Card className="p-spacing-xl">
              ...
              <ul className="space-y-3 mb-6">
                ...
                <li className="flex items-start">
                  <span className="text-green-500 mr-2">✓</span>
                  <span className="text-gray-700">Live saxofonist Oss (2 uur)</span>
                </li>
                <li className="flex items-start">
                  <span className="text-green-500 mr-2">✓</span>
            ...
            <Card className="p-spacing-xl border-2 border-brand-600">
              ...
              <ul className="space-y-3 mb-6">
                ...
                <li className="flex items-start">
                  <span className="text-green-500 mr-2">✓</span>
                  <span className="text-gray-700">Live saxofonist Oss (4 uur)</span>
                </li>
                <li className="flex items-start">
                  <span className="text-green-500 mr-2">✓</span>
      ...
      <section className="py-spacing-3xl px-spacing-xl bg-gray-50">
        <div className="container mx-auto max-w-4xl">
          <h2 className="font-display text-3xl font-bold text-gray-900 mb-6">
            Veelgestelde Vragen Saxofonist Oss
          </h2>

          <div className="space-y-4">
            <details className="group bg-white border border-gray-200 rounded-lg p-6">
              <summary className="cursor-pointer font-semibold">
                Wat kost een saxofonist in Oss?
              </summary>
              <p className="mt-4 text-gray-600">
                Een saxofonist Oss in combinatie met DJ kost vanaf €1.345 voor 2 uur live sax.
            ...
            <details className="group bg-white border border-gray-200 rounded-lg p-6">
              <summary className="cursor-pointer font-semibold">
                Welke muziek speelt de saxofonist Oss?
              </summary>
              <p className="mt-4 text-gray-600">
                Onze saxofonist Oss speelt live mee met house, deep house, lounge, jazz en party classics.
            ...
            <details className="group bg-white border border-gray-200 rounded-lg p-6">
              <summary className="cursor-pointer font-semibold">
                Is de saxofonist Oss ook beschikbaar zonder DJ?
              </summary>
              <p className="mt-4 text-gray-600">
                Ja! Onze saxofonist Oss kan ook solo optreden tijdens borrels, diners of ceremonies.
      ...
      <section className="py-spacing-3xl px-spacing-xl bg-gradient-to-r from-amber-600 via-orange-600 to-pink-600 text-white">
        <div className="container mx-auto max-w-4xl text-center">
          <h2 className="font-display text-3xl md:text-4xl font-bold mb-4">
            Boek Nu Saxofonist Oss
          </h2>
          <p className="text-xl mb-8 opacity-95">
            Maak je event in Oss onvergetelijk met een live saxofonist
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button size="lg" variant="secondary" className="bg-white text-orange-600 hover:bg-gray-50">
              Vraag saxofonist Oss offerte
            </Button>
