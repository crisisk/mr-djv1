...
export default function SHertogenboschPage() {
  return (
    <>
      <HeroSection
        eyebrow="DJ &apos;s-Hertogenbosch"
        title="DJ Huren in &apos;s-Hertogenbosch"
        subtitle="Professionele DJ service voor bruiloften, feesten en bedrijfsevents in &apos;s-Hertogenbosch en omgeving"
        ...
        badges={['Lokale DJ', '15+ jaar ervaring', 'Noord-Brabant']}
        socialProof="⭐ 5.0 sterren • Specialist in &apos;s-Hertogenbosch en omgeving"
      />
        ...
        <div className="container mx-auto max-w-4xl">
          <div className="text-center mb-12">
            <h2 className="font-display text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              DJ Service in &apos;s-Hertogenbosch
            </h2>
            <p className="text-lg text-gray-600">
              Als ervaren DJ in Noord-Brabant verzorgen wij professionele events in &apos;s-Hertogenbosch en omgeving.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <Card className="text-center p-spacing-lg">
              ...
              <p className="text-gray-600 text-sm">
                Bekend met alle populaire locaties in &apos;s-Hertogenbosch.
              </p>
            </Card>
            ...
            <Card className="text-center p-spacing-lg">
              ...
              <p className="text-gray-600 text-sm">
                15+ jaar ervaring in Noord-Brabant.
              </p>
            </Card>
      ...
      <section className="py-spacing-3xl px-spacing-xl bg-gray-50">
        <div className="container mx-auto">
          <div className="text-center mb-12">
            <h2 className="font-display text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              DJ Services in &apos;s-Hertogenbosch
            </h2>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6 lg:gap-8 max-w-5xl mx-auto">
            <Card className="p-spacing-lg">
              ...
              <p className="text-gray-600 mb-4">
                Professionele DJ voor jullie bruiloft in &apos;s-Hertogenbosch.
              </p>
            ...
            <Card className="p-spacing-lg">
              ...
              <p className="text-gray-600 mb-4">
                Professionele DJ voor bedrijfsevents in &apos;s-Hertogenbosch.
              </p>
      ...
      <section id="pricing" className="py-spacing-3xl px-spacing-xl bg-white">
        <div className="container mx-auto">
          <div className="text-center mb-12">
            <h2 className="font-display text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Pakketten voor &apos;s-Hertogenbosch
            </h2>
            <p className="text-lg text-gray-600">
      ...
      <section className="py-spacing-3xl px-spacing-xl bg-brand-gradient text-white">
        <div className="container mx-auto max-w-4xl text-center">
          <h2 className="font-display text-3xl md:text-4xl font-bold mb-4">
            Klaar voor een Onvergetelijk Feest in &apos;s-Hertogenbosch?
          </h2>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button
              ...
              onClick={() => window.open('https://wa.me/31620383638?text=Hallo%20Mister%20DJ%2C%20ik%20wil%20graag%20informatie%20over%20s-Hertogenbosch', '_blank')}
            >
              💬 WhatsApp Contact
            </Button>
          </div>
