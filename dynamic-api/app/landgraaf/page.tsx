...
export default function LandgraafPage() {
  return (
    <>
      <HeroSection
        eyebrow="DJ Landgraaf"
        title="DJ Huren in Landgraaf"
        subtitle="Professionele DJ service voor bruiloften, feesten en bedrijfsevents in Landgraaf en omgeving"
        ...
        socialProof="⭐ 5.0 sterren • Specialist in Landgraaf en omgeving"
      />
        ...
        <div className="container mx-auto max-w-4xl">
          <div className="text-center mb-12">
            <h2 className="font-display text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              DJ Service in Landgraaf
            </h2>
            <p className="text-lg text-gray-600">
              Als ervaren DJ in Limburg verzorgen wij professionele events in Landgraaf en omgeving.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <Card className="text-center p-spacing-lg">
              ...
              <p className="text-gray-600 text-sm">
                Bekend met alle populaire locaties in Landgraaf.
              </p>
            </Card>
          ...
          <div className="grid md:grid-cols-3 gap-6 lg:gap-8 max-w-5xl mx-auto">
            <Card className="p-spacing-lg">
              ...
              <p className="text-gray-600 mb-4">
                Professionele DJ voor jullie bruiloft in Landgraaf.
              </p>
            ...
            <Card className="p-spacing-lg">
              ...
              <p className="text-gray-600 mb-4">
                Professionele DJ voor bedrijfsevents in Landgraaf.
              </p>
      ...
      <section className="py-spacing-3xl px-spacing-xl bg-brand-gradient text-white">
        <div className="container mx-auto max-w-4xl text-center">
          <h2 className="font-display text-3xl md:text-4xl font-bold mb-4">
            Klaar voor een Onvergetelijk Feest in Landgraaf?
          </h2>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button
              ...
              onClick={() => window.open('https://wa.me/31620383638?text=Hallo%20Mister%20DJ%2C%20ik%20wil%20graag%20informatie%20over%20Landgraaf', '_blank')}
            >
              💬 WhatsApp Contact
            </Button>
          </div>
