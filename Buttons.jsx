...
const VARIANT_STYLES = {
  primary:
    'bg-primary text-neutral-light hover:bg-primary/90 focus-visible:ring-primary/40',
  secondary:
    'bg-secondary text-neutral-dark hover:bg-secondary/90 focus-visible:ring-secondary/40',
  outline:
    'border border-neutral-dark text-neutral-dark hover:bg-neutral-light focus-visible:ring-neutral-dark/40',
  ghost:
    'text-neutral-dark hover:bg-neutral-gray-100 focus-visible:ring-neutral-dark/30',
  gradient:
