...
const baseLocalSeoData = [
  {
    ...
    locales: ["nl-NL"],
    localUSP:
      "Dé beste DJ voor uw feest in Eindhoven en omgeving. Bekend met alle top-locaties zoals het Evoluon en de Effenaar.",
    ...
    seoDescription:
      "Zoek niet verder! Huur de beste DJ van Eindhoven voor uw bruiloft, bedrijfsfeest of verjaardag. Bekend met alle locaties.",
    isDefault: true,
  },
  {
    city: "Maastricht",
    ...
    locales: ["nl-NL"],
    localUSP:
      "Uw specialist in sfeervolle feesten in het hart van Limburg. Van het Vrijthof tot de Maas, wij kennen de Limburgse gezelligheid.",
    ...
    seoDescription:
      "Huur een professionele DJ in Maastricht voor een onvergetelijke avond. Wij zorgen voor de perfecte Limburgse sfeer.",
  },
  {
    city: "Tilburg",
    province: "Noord-Brabant",
    ...
    locales: ["nl-NL"],
    localUSP:
      "De DJ die de Tilburgse kermismentaliteit naar uw feest brengt. Van de Piushaven tot de Spoorzone, wij maken er een knalfeest van.",
    ...
    seoDescription:
      "Zoekt u een DJ in Tilburg? Wij garanderen een onvergetelijk feest op elke locatie in en rondom Tilburg.",
  },
  {
    city: "Breda",
    province: "Noord-Brabant",
    ...
    locales: ["nl-NL"],
    localUSP:
      "Stijlvolle en energieke DJ-sets voor de bourgondische feesten in Breda. Van de Grote Markt tot het Mastbos, wij zijn uw muzikale partner.",
    ...
    seoDescription:
      "Huur een professionele DJ in Breda voor uw bruiloft of bedrijfsfeest. Wij leveren maatwerk voor een onvergetelijke avond.",
  },
  {
    city: "Venlo",
    province: "Limburg",
    ...
    locales: ["nl-NL"],
    localUSP:
      "De perfecte mix van Limburgse gezelligheid en internationale hits voor uw feest in Venlo. Wij kennen de lokale smaak.",
    ...
    seoDescription:
      "Zoek een DJ in Venlo die uw feest naar een hoger niveau tilt. Van bruiloft tot bedrijfsfeest, wij regelen de muziek.",
  },
];
