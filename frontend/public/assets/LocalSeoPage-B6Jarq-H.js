import{j as e}from"./index-ccMXw3nJ.js";import{H as m,a as h,C as g}from"./ContactForm-CnpQRJkr.js";const y=({data:s,pricingSection:i,testimonialsSection:l,variant:n})=>{if(!s)return e.jsx("div",{children:"Geen lokale SEO data gevonden."});const{city:t,province:a,localUSP:r,localReviews:u,localVenues:c,seoTitle:o,seoDescription:d}=s;return e.jsxs("div",{className:"LocalSeoPage",children:[e.jsxs(m,{children:[e.jsx("title",{children:o}),e.jsx("meta",{name:"description",content:d}),e.jsx("script",{type:"application/ld+json",children:`
                        {
