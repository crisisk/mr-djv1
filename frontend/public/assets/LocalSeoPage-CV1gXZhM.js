import{j as e}from"./index-COLfFGhu.js";import{a as m,H as h,b as g,C as u}from"./ContactForm-DwFhqNMW.js";const v=({data:s,pricingSection:i,testimonialsSection:l,variant:n})=>{if(!s)return e.jsx("div",{children:"Geen lokale SEO data gevonden."});const{city:t,province:a,localUSP:r,localReviews:j,localVenues:c,seoTitle:o,seoDescription:d}=s;return e.jsxs("div",{className:"LocalSeoPage",children:[e.jsx(m,{}),e.jsxs(h,{children:[e.jsx("title",{children:o}),e.jsx("meta",{name:"description",content:d}),e.jsx("script",{type:"application/ld+json",children:`
                        {
