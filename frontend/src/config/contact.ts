...
const rawPhone =
  resolveEnvValue(
    (import.meta.env as unknown as Record<string, unknown>)?.VITE_CONTACT_PHONE_NUMBER,
...
export const CONTACT_WHATSAPP_MESSAGE =
  resolveEnvValue(
    (import.meta.env as unknown as Record<string, unknown>)?.VITE_WHATSAPP_DEFAULT_MESSAGE,
