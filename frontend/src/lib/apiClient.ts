...
const normaliseBody = (body: ApiClientOptions["body"], headers: Headers): RequestInit["body"] => {
...
export const apiClient = {
  ...
  delete<T = unknown>(path: string | URL, options?: Omit<ApiClientOptions, "method" | "body">) {
